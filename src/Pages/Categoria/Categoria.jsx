            ...
            <main className=" w-full h-[663px]">
                <div className='grid grid-cols-12 h-full'>
                    ...
                    <div className="col-span-10 bg-gradient-to-b from-purple-700 to-fuchsia-600">
                        ...
                        <div className='grid grid-cols-2 border-b-2 border-t-2 text-white'>
                            <div className="col-span-1 ms-20 mb-2 mt-2">
                                <p>Nome</p>
                            </div>
                            <div className="col-span-1 flex justify-end gap-[104px] me-[52px] mb-2 mt-2">
